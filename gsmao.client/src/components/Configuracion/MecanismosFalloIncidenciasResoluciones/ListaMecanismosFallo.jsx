...
import {MecanismoFalloFormModal} from "./MecanismoFalloFormModal";
...
export const ListaMecanismosFallo = () => {
    const {t} = useTranslation();
    const {items, isLoading, isRefetching, fetchData} = useFetchListData(mecanismosFallosService.fetchAll);
    ...
    return (
        <>
            ...
            <div>
                <MecanismosFalloTable items={items} isLoading={isLoading} ActionsComponent={ActionsComponent} />
            </div>
        </>
    );
};

export const MecanismosFalloTable = ({items, isLoading, ActionsComponent, ...rest}) => {
    const {t} = useTranslation();
    const columns = [
        {
            field: "descripcionES",
    ...
    return <TableComponent isLoading={isLoading} data={items} columnDefs={columns} tableId="tablaMecanismosFallo" {...rest} />;
};
