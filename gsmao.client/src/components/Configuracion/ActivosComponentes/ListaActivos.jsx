...
export const ActivosTable = ({items, isLoading, ActionsComponent, ...rest}) => {
    ...
    const columns = [
        ...
        {
            field: "redundancia",
            headerName: t("Redundancia"),
            valueGetter: (e) => e.data?.redundancia || 0,
            flex: 1,
            minWidth: 110,
        },
        {
            field: "hse",
            headerName: t("HSE"),
            valueGetter: (e) => e.data?.hse || 0,
            flex: 1,
            minWidth: 50,
        },
        {
            field: "usabilidad",
            headerName: t("Usabilidad"),
            valueGetter: (e) => e.data?.usabilidad || 0,
            flex: 1,
            minWidth: 100,
        },
        {
        ...
        {
            field: "centroCoste",
            headerName: t("Centro de Costes"),
            valueGetter: (e) => e.data?.centroCoste?.descripcionES,
            valueFormatter: (e) => t(e.value),
            flex: 2.5,
            minWidth: 155,
        },
